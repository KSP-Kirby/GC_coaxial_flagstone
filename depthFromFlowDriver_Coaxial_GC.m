% version 25 Aug 2016 - for coaxial flagstone scene
    ...
    for dataFactor = [90]
        for horzNeighborMaskWeight = [5]
            for verticalNeighborMaskWeight = [2]
                ...
                minLabel = 60;
                maxLabel = 300;
                f_b = 1005.52555*.006;       % from calibration done on 2016/7/16
                f_f = 1320.1734*.006;       % from calibration done on 2016/7/16
                ...
                addpath('C:\Users\richa\Documents\MATLAB\gco-v3.0\matlab')
